  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属学院" prop="college">
        <el-select v-model="queryParams.college" placeholder="请选择所属学院" clearable size="small">
      ...
      <el-form-item label="成果类型" prop="typesresults">
        <el-select v-model="queryParams.typesresults" placeholder="请选择成果类型" clearable size="small">
          <el-option
      ...
      <el-form-item label="技术成熟度" prop="technologylevel" :style="{ whiteSpace: 'nowrap'}" >
        <el-select  v-model="queryParams.technologylevel" placeholder="请选择技术成熟度" clearable size="small"   class="a1"  >
          <el-option
      ...
      <el-form-item label="先进度" prop="advancementleve">
        <el-select v-model="queryParams.advancementleve" placeholder="请选择先进度" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="tecachievementList" @selection-change="handleSelectionChange"  >
      ...
      <el-table-column label="所属领域" align="center" prop="fieldDeatil" width="90" :show-overflow-tooltip="true"  >
      </el-table-column>
      ...
      <el-table-column label="成果类型" align="center" prop="typesresultsDeatil" width="120"  :show-overflow-tooltip="true">
      ...
      <el-table-column label="通讯地址" align="center" prop="address"  :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['tec:tecachievement:audited']"
          >审核</el-button>
          <el-button
            size="mini"
            type="text"
  ...
  methods: {
    ...
    getList() {
      ...
      listTecachievement(this.queryParams).then(response => {
        ...
        this.loading = false;
        console.log('listTecachievement--->', this.tecachievementList)
      });
    },
